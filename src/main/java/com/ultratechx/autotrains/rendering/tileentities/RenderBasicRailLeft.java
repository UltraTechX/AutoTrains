...
import com.ultratechx.autotrains.models.ModelBasicRailLeft;
...
public class RenderBasicRailLeft extends TileEntitySpecialRenderer{

	ModelBasicRailLeft model;
	private ResourceLocation texture = new ResourceLocation("autotrains:textures/blocks/rail_normal_left.png");
	
	
	public RenderBasicRailLeft(){
		model = new ModelBasicRailLeft();
	}
